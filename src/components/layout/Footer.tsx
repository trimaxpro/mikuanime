...
export function Footer() {
  return (
    <footer className="mt-12 border-t border-border-subtle/80 bg-surface/30 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 pt-6 pb-4 flex flex-col md:flex-row items-center justify-between gap-4 font-body">
        ...
        <div className="md:w-1/3 flex items-center justify-center md:justify-end gap-3 text-text-secondary text-[14.5px] sm:text-[15px]">
          <Link
            to="/terms"
            className="hover:text-accent-glow transition-colors duration-200 flex items-center gap-2 font-medium hover:bg-white/[0.04] px-3 h-9 rounded-full border border-transparent hover:border-border-subtle/60"
          >
